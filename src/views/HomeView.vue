...
const games = computed(() => [
  ...
  { route: '/typing', icon: '写', title: '汉字输入', subtitle: t('card.typing.subtitle'), description: t('card.typing.desc'), gradient: 'linear-gradient(135deg, #2d3436, #636e72)', tags: ['Beginner - HSK9', t('tag.vocabulary'), t('tag.reading')] },
