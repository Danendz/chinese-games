<template>
  <div class="game-view">
    <div class="game-header">
      <h1 class="game-title text-chinese">成语填空</h1>
      <p class="game-subtitle">{{ t('view.idiom') }}</p>
    </div>
...
import IdiomFill from '../components/idiom/IdiomFill.vue'
...
function onGameComplete() {
  ...
  addGameSession('idioms', timer.elapsed.value, score.correct.value)
}
function onRoundComplete() {
  if (infiniteMode.value) addGameSession('idioms', timer.elapsed.value, score.correct.value)
}
