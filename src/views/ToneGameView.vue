...
import ToneQuiz from '../components/tone/ToneQuiz.vue'
...
function onGameComplete() {
  ...
  addGameSession('tone', timer.elapsed.value, score.correct.value)
}
function onRoundComplete() {
  if (infiniteMode.value) addGameSession('tone', timer.elapsed.value, score.correct.value)
}
