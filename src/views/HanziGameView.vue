<template>
  <div class="game-view">
    <div class="game-header">
      <h1 class="game-title text-chinese">汉字手写</h1>
      <p class="game-subtitle">{{ t('view.hanzi') }}</p>
    </div>
...
import HanziQuiz from '../components/writing/HanziQuiz.vue'
...
function onGameComplete() {
  ...
  addGameSession('hanzi', timer.elapsed.value, score.correct.value)
}
