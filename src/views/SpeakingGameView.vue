<template>
  <div class="game-view">
    <div class="game-header">
      <h1 class="game-title text-chinese">跟读练习</h1>
      <p class="game-subtitle">{{ t('view.speaking') }}</p>
    </div>
...
import ReadAloud from '../components/speaking/ReadAloud.vue'
...
function onGameComplete() {
  ...
  addGameSession('speaking', timer.elapsed.value, score.correct.value)
}
